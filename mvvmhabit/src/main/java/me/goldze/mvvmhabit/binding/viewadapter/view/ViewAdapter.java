...
public class ViewAdapter {
    ...
    @BindingAdapter(value = {"onClickCommandWithView", "isThrottleFirst"}, requireAll = false)
    public static void onClickCommandWithView(View view, final BindingCommand clickCommand, final boolean isThrottleFirst) {
        if (isThrottleFirst) {
            RxView.clicks(view)
                    .subscribe(new Consumer<Object>() {
                        @Override
